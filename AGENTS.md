...
<tbody>
<tr>
<td class="org-left"><code>ctx stats</code></td>
<td class="org-left">Call the <code>stats</code> MCP tool and display the full output verbatim</td>
</tr>

<tr>
<td class="org-left"><code>ctx doctor</code></td>
<td class="org-left">Call the <code>doctor</code> MCP tool, run the returned shell command, display as checklist</td>
</tr>

<tr>
<td class="org-left"><code>ctx upgrade</code></td>
<td class="org-left">Call the <code>upgrade</code> MCP tool, run the returned shell command, display as checklist</td>
</tr>
</tbody>
</table>
