...
const eng: Record<string, string> = {
  ...
  [electronUpdateI18n.installFailed]: 'Failed to install Electron update',
  [electronUpdateI18n.failed]: 'Electron updater failed: {message}',
  ...
  [extensionI18nKeys.orgAgendaDateFilterRange]: 'Range',
  [extensionI18nKeys.orgAgendaDateFilterClear]: 'Clear dates',
  [extensionI18nKeys.orgAgendaDateFilterCancel]: 'Cancel',
  [extensionI18nKeys.orgAgendaDateFilterApply]: 'Apply',
  ...
  [extensionI18nKeys.orgAgendaPomodoroCompleteTaskTitle]: 'Complete task?',
  [extensionI18nKeys.orgAgendaPomodoroCompleteTaskMessage]: 'Mark the current Pomodoro task as done?',
  [extensionI18nKeys.orgAgendaPomodoroCompleteTaskConfirm]: 'Complete task',
  [extensionI18nKeys.orgAgendaPomodoroCompleteTaskCancel]: 'Stop only',
  ...
  [extensionI18nKeys.orgAgendaTaskTimeTitle]: 'Add time',
  [extensionI18nKeys.orgAgendaTaskTimeDuration]: 'Duration',
  [extensionI18nKeys.orgAgendaTaskTimeHours]: 'Hours',
  [extensionI18nKeys.orgAgendaTaskTimeMinutes]: 'Minutes',
  [extensionI18nKeys.orgAgendaTaskTimeStart]: 'Start time (optional)',
  [extensionI18nKeys.orgAgendaTaskTimeEnd]: 'Ends at',
  [extensionI18nKeys.orgAgendaTaskTimeAdd]: 'Add time',
