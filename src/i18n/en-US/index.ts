...
const eng: Record<string, string> = {
  ...
  [I18N.ELECTRON_UPDATE_READY]: 'Application update is ready',
  [I18N.ELECTRON_UPDATE_RESTART_TO_INSTALL]: 'Click to restart and install the update',
  [I18N.ELECTRON_UPDATE_VERSION_READY]: 'Version {version} is ready. Click to restart and install it.',
  [I18N.ELECTRON_UPDATE_INSTALL_FAILED]: 'Failed to install Electron update',
  [I18N.ELECTRON_UPDATE_FAILED]: 'Electron updater failed: {message}',
