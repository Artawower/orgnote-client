...
export type { TagContext, TagRange } from './tags/find-org-tag-ranges';
export { findOrgTagRanges } from './tags/find-org-tag-ranges';
...
export const createOrgEditorExtensions = (
  ...
  const multilineExts: Extension[] = opts.singleLine
    ...
    : [
        ...
        EditorView.theme({
          '&': {
            minHeight: opts.minHeight ?? '60px',
            maxHeight: opts.maxHeight ?? '200px',
            overflow: 'auto',
          },
        }),
      ];
